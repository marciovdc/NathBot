	          ...
	          if (!isUser) return reply(mess.only.daftarB)
               ...
               if (anu.error) return reply(anu.error)
                ...
                case 'truth':
					...
					break
                                case 'dare':
					const dare =['Envie uma mensagem para o seu ex e diga "Eu ainda gosto de você",'"cada digitação no gc / pc por 1 dia ',' enviar uma nota de voz dizendo posso te ligar, baby? ',' solte uma música / quote, continue As tags de membros são adequadas para a citação ',' use uma foto do Sule por 3 dias ',' digite no idioma local 24 horas ',' mude o nome para Sou uma criança fofa, luna por 5 horas ',' bate-papo com contatos wa o pedido de acordo com% sua bateria, continue dizendo a ele tive sorte em ter você ',' bate-papo ex e diga eu te amo, pgn de volta ',' gravar voz ler surah al-kautsar ',' disse eu tenho uma queda por você, quer meu namorado ou não? para o último sexo oposto que você conseguiu conversar (entregar em wa / tele), espere ele responder, se ss cair aqui ', 'diga o tipo de sua namorada!', 'tire / poste fotos de namorada / esmague', 'gritou gajelas e envie usando vn aqui', 'faça um papinho na cara e envie para um de seus amigos u ',' envie sua foto com uma legenda, sou um filho adotivo ',' gritou com palavras ásperas enquanto Vn então a enviou aqui ',' mude o nome para BOWO por 24 horas ',' Fingir estar possuído, por exemplo: ser possuído por um cachorro aidetico, possuído por um gafanhoto, possuído por uma geladeira, etc. '
				]
